...
public class RestrictedEntityResourceIT {
    ...
    public void setup() {
        ...
        final RestrictedEntityResource restrictedEntityResource = new RestrictedEntityResource(restrictedEntityRepository);
    ...
    public void createRestrictedEntity() throws Exception {
        ...
        assertThat(testRestrictedEntity.getName()).isEqualTo(DEFAULT_NAME);
    }
    ...
    public void updateRestrictedEntity() throws Exception {
        ...
        RestrictedEntity testRestrictedEntity = restrictedEntityList.get(restrictedEntityList.size() - 1);
        assertThat(testRestrictedEntity.getName()).isEqualTo(UPDATED_NAME);
    }
